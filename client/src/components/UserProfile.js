    ...
    <main className='content'>
      <header className='content-header' style={{ background: `url(${!arbitraryUser.cover_photo_url ? blankCoverPhoto : arbitraryUser.cover_photo_url})`}}>
        ...
        {arbitraryUser.id === user.id ?
          ...
          : (user.assertive_friendships.map(assertiveFriendship => assertiveFriendship.friend.id).includes(arbitraryUser.id) ? <button onClick=
          {deleteFriendshipHandler} className='content-header-btn'>Friends</button> : <button onClick={addFriendshipHandler} 
          className='content-header-btn'>Add Friend</button>)}  {/* ternary within a ternary */}
      </header>
      ...
      <section className='content-sidebar'>
        ...
        <div className='profile-info'>
          ...
          <p>
            Like to hack people's data for ads and money. Lol. Time to takeover the Metaverse! 
          </p>
        </div>
